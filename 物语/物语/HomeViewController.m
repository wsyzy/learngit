...
- (UIImageView *)tableImageView     //书桌图片
{
    if (!_tableImageView) {
...
//        [_giftBtn addTarget:self action:@selector(bookBtnClick) forControlEvents:UIControlEventTouchUpInside];
    }
    return _giftBtn;
}
